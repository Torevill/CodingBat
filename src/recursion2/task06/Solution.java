...
public class Solution {
    ...
    public boolean splitArrayHelper(int start, int[] nums, int group1, int group2) {
        ...
        else if (splitArrayHelper(start + 1, nums, group1 + nums[start], group2)) return true;
        else if (splitArrayHelper(start + 1, nums, group1, group2 + nums[start])) return true;
        else return false;
    }
