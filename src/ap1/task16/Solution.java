...
and ending at the end index. For example, with the heights {5, 3, 6, 7, 2} and start=2, end=4 yields a sum of 1 + 5 = 6.
...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(sol.sumHeights(new int[]{5, 3, 6, 7, 2}, 2, 4));
    }
